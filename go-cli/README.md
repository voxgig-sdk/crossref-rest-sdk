...
AQL-driven CLI and REPL for the CrossrefRest SDK. Positional arguments are
...
./crossref-rest-cli list funder
./crossref-rest-cli load 1 funder
./crossref-rest-cli load '{id:1}' funder
