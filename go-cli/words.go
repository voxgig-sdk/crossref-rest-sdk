...
func registerSDKWords(r *eng.Registry, client *sdk.CrossrefRestSDK) {
...
func runOp(client *sdk.CrossrefRestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
