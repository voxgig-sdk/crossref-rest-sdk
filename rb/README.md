...
The Ruby SDK for the CrossrefRest API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `CrossrefRestError` (a `StandardError` subclass), so wrap
