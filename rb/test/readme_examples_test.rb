...
#      offline in seeded test mode (CrossrefRestSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CrossrefRest_sdk.rb")
  SDK_CLASS = "CrossrefRestSDK"
