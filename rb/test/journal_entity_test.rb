...
class JournalEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CROSSREF_REST_TEST_JOURNAL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def journal_basic_setup(extra)
  ...
  entid_env_raw = ENV["CROSSREF_REST_TEST_JOURNAL_ENTID"]
