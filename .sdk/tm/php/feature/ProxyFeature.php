...
// CrossrefRest SDK proxy feature
...
class CrossrefRestProxyFeature extends CrossrefRestBaseFeature
{
    ...
    public function init(CrossrefRestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CrossrefRestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
