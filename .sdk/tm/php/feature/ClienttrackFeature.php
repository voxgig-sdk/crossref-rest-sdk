...
// CrossrefRest SDK clienttrack feature
...
class CrossrefRestClienttrackFeature extends CrossrefRestBaseFeature
{
    ...
    public function PostConstruct(CrossrefRestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CrossrefRest-SDK';
