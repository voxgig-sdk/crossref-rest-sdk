...
// CrossrefRest SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CrossrefRestOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CrossrefRestOmni::structfix($now, Struct::undef()))
                        !== json_encode(CrossrefRestOmni::structfix($val, Struct::undef()))) {
