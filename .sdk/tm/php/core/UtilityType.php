...
// CrossrefRest SDK utility type

class CrossrefRestUtility
{
    ...
    public static function copy(CrossrefRestUtility $src): CrossrefRestUtility
    {
        $u = new CrossrefRestUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
