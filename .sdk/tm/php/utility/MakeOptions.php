...
// CrossrefRest SDK utility: make_options

class CrossrefRestMakeOptions
{
    ...
    public static function call(CrossrefRestContext $ctx): array
    {
        ...
        //
        // `CrossrefRestSchema::optspec()` is built from the model:
        ...
        $optspec = CrossrefRestSchema::optspec();
