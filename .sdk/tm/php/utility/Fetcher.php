...
// CrossrefRest SDK utility: fetcher

class CrossrefRestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CrossrefRestSDK/1.0)';
    ...
    public static function call(CrossrefRestContext $ctx, string $fullurl, array $fetchdef): array
    {
