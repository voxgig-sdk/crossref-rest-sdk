...
from projectname_sdk.core.control import CrossrefRestControl
from projectname_sdk.core.error import CrossrefRestError


def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import CrossrefRestContext
        ctx = CrossrefRestContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, CrossrefRestError):
        errmsg = err.msg
    ...
    sdk_err = CrossrefRestError("", msg, ctx)
