...
|---|---|---|
| `ts/` | @voxgig-sdk/crossref-rest-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/crossref-rest-sdk \
      --repository voxgig-sdk/crossref-rest-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/crossref-rest-sdk` shows it, and
`npm trust revoke @voxgig-sdk/crossref-rest-sdk --id=<id>` removes it.
