...
describe("JournalDirect", function()
  it("should direct-load-journal", function()
    local setup = journal_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-journal", setup.live and "live" or "unit")
...
function journal_direct_setup(mockres)
