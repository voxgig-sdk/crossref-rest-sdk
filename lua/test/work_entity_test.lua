...
describe("WorkEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CROSSREFREST_TEST_WORK_ENTID JSON to run live")
      return
    end
...
function work_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CROSSREFREST_TEST_WORK_ENTID")
