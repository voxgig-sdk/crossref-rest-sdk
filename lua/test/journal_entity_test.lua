...
describe("JournalEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CROSSREF_REST_TEST_JOURNAL_ENTID JSON to run live")
      return
    end
...
function journal_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CROSSREF_REST_TEST_JOURNAL_ENTID")
