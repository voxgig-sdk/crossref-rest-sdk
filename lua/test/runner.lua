...
function runner.env_override(m)
  local live = runner.getenv("CROSSREFREST_TEST_LIVE")
  local override = runner.getenv("CROSSREFREST_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CROSSREFREST_TEST_EXPLAIN")
