...
function runner.env_override(m)
  local live = runner.getenv("CROSSREF_REST_TEST_LIVE")
  local override = runner.getenv("CROSSREF_REST_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CROSSREF_REST_TEST_EXPLAIN")
