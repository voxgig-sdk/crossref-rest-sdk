...
local SDK_MODULE = "crossref-rest_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["funder"] = { ["test01"] = { id = "test01" } }, ["journal"] = { ["test01"] = { id = "test01" } }, ["member"] = { ["test01"] = { id = "test01" } }, ["type"] = { ["test01"] = { id = "test01" } }, ["work"] = { ["test01"] = { id = "test01" } } } }'
