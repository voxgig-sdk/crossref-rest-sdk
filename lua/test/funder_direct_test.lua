...
describe("FunderDirect", function()
  it("should direct-load-funder", function()
    local setup = funder_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-funder", setup.live and "live" or "unit")
...
function funder_direct_setup(mockres)
