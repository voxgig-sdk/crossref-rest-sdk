...
describe("MemberEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CROSSREFREST_TEST_MEMBER_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    assert.is_not_nil(member_ref01_data_dt0_loaded)
...
function member_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CROSSREFREST_TEST_MEMBER_ENTID")
