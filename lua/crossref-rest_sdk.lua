...
-- by passing it.
function CrossrefRestSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CrossrefRestSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "CrossrefRestSDK: graphql: " .. msg
    res.graphql = errors
  end
