...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/crossref-rest` | `npm install @voxgig-sdk/crossref-rest` |
| Python | `voxgig-sdk-crossref-rest` | `pip install voxgig-sdk-crossref-rest` |
| PHP | `voxgig-sdk/crossref-rest` | `composer require voxgig-sdk/crossref-rest` |
| Golang | `github.com/voxgig-sdk/crossref-rest-sdk/go` | `go get github.com/voxgig-sdk/crossref-rest-sdk/go` |
| Ruby | `voxgig-sdk-crossref-rest` | `gem install voxgig-sdk-crossref-rest` |
| Lua | `voxgig-sdk-crossref-rest` | `luarocks install voxgig-sdk-crossref-rest` |
