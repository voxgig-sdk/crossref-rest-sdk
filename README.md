...
The Crossref REST API allows users to search and retrieve metadata for scholarly works, including DOIs, ISSNs, and funder identifiers.

Learn more about Crossref REST API at [api.crossref.org/swagger-ui/index.html](https://api.crossref.org/swagger-ui/index.html).
...
This SDK exposes the API as a small set of **semantic entities** — Funder, Journal, Member, Type and Work — that you
