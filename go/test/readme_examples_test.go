...
const testSeed = `map[string]any{"entity": map[string]any{"funder": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "journal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "work": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
