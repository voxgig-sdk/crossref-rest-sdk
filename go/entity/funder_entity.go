...
import (
	...
	vs "github.com/voxgig-sdk/crossref-rest-sdk/go/utility/struct"
)

type FunderEntity struct {
	name    string
	client  *core.CrossrefRestSDK
...
func NewFunderEntity(client *core.CrossrefRestSDK, entopts map[string]any) *FunderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FunderEntity) GetName() string { return e.name }
...
func (e *FunderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FunderEntity) Deleted() bool {
	return e.deleted
}


func (e *FunderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFunderEntity(e.client, opts)
}

func (e *FunderEntity) Data(args ...any) any {
...
func (e *FunderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *FunderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FunderEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FunderEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FunderEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FunderEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FunderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
