// Command CrossrefRest-mcp is an MCP server exposing the CrossrefRest
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CrossrefRest_list  — list records of an entity
//	CrossrefRest_load  — load a single record of an entity
//
