...
(0, node_test_1.describe)('FunderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CrossrefRestSDK({
    ...
    (0, node_test_1.test)('direct-load-funder', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-funder', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CROSSREF_REST_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CrossrefRestSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CROSSREF_REST_TEST_FUNDER_ENTID'];
    ...
    const client = new __1.CrossrefRestSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=FunderDirect.test.js.map