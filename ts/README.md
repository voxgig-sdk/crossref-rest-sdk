# CrossrefRest TypeScript SDK



The TypeScript SDK for the CrossrefRest API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Funder()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `CrossrefRestSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `CrossrefRestSDK.test(testopts?, sdkopts?)` | `CrossrefRestSDK` | Create a test-mode client. |
...
| `client` | `client(): CrossrefRestSDK` | Return the parent SDK client. |
...
crossref-rest/
├── src/
│   ├── CrossrefRestSDK.ts        # Main SDK class
