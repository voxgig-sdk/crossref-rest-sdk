...
The PHP SDK for the CrossrefRest API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Funder(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->CrossrefRest(null)->load(
    ["id" => "test01"], null
);
