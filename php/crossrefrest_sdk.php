...
class CrossrefRestSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $utility = new CrossrefRestUtility();
        ...
        $feature_opts = CrossrefRestHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = CrossrefRestHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!CrossrefRestFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, CrossrefRestFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return CrossrefRestUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = CrossrefRestHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = CrossrefRestHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = CrossrefRestHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new CrossrefRestError($op . "_allow",
                "CrossrefRestSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = CrossrefRestHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new CrossrefRestError("graphql_error",
                "CrossrefRestSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Funder($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_funder === null) {
                $this->_funder = new FunderEntity($this, null);
            }
            return $this->_funder;
        }
        return new FunderEntity($this, $data);
    }
    ...
    public function Journal($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_journal === null) {
                $this->_journal = new JournalEntity($this, null);
            }
            return $this->_journal;
        }
        return new JournalEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new CrossrefRestSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
