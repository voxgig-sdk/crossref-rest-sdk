...
// CrossrefRest SDK netsim feature
...
class CrossrefRestNetsimFeature extends CrossrefRestBaseFeature
{
    ...
    private function _simulate(CrossrefRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CrossrefRestContext $ctx, array $applied): void
    {
        $client = $this->client;
