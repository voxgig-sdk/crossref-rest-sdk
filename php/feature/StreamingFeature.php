...
// CrossrefRest SDK streaming feature
...
class CrossrefRestStreamingFeature extends CrossrefRestBaseFeature
{
    ...
    private function _iterate(CrossrefRestResult $result): \Generator
    {
    ...
    private function _streamable(CrossrefRestContext $ctx): bool
    {
