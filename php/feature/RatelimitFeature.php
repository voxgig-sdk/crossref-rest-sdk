...
// CrossrefRest SDK ratelimit feature
...
class CrossrefRestRatelimitFeature extends CrossrefRestBaseFeature
{
    ...
    private function _acquire(CrossrefRestContext $ctx): void
    {
    ...
    private function _track(CrossrefRestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
