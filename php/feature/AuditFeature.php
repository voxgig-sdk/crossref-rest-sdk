...
// CrossrefRest SDK audit feature
...
class CrossrefRestAuditFeature extends CrossrefRestBaseFeature
{
    ...
    private function _emit(CrossrefRestContext $ctx, string $outcome): void
    {
