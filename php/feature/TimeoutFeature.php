...
// CrossrefRest SDK timeout feature
...
class CrossrefRestTimeoutFeature extends CrossrefRestBaseFeature
{
    ...
    private function _with_timeout(CrossrefRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CrossrefRestContext $_ctx, float $ms): void
    {
        $client = $this->client;
