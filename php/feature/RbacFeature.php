...
class CrossrefRestRbacFeature extends CrossrefRestBaseFeature
{
    ...
    private function _required(CrossrefRestContext $ctx): ?string
    {
    ...
    private function _reject(CrossrefRestContext $ctx, string $required): void
    {
    ...
    private function _track(CrossrefRestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
