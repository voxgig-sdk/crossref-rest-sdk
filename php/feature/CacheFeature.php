...
// CrossrefRest SDK cache feature
...
class CrossrefRestCacheFeature extends CrossrefRestBaseFeature
{
    ...
    private function _through(CrossrefRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
