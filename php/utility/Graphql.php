...
// CrossrefRest SDK utility: graphql
//
...
class CrossrefRestGraphql
{
    ...
    // equivalent.
    public static function body(CrossrefRestContext $ctx): mixed
    {
    ...
    public static function errors(CrossrefRestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
