...
// CrossrefRest SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CrossrefRestTransformResponse
{
    public static function call(CrossrefRestContext $ctx): mixed
    {
        ...
        $transform = CrossrefRestHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
