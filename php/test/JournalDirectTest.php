...
class JournalDirectTest extends TestCase
{
    public function test_direct_load_journal(): void
    {
        $setup = journal_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-journal", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
