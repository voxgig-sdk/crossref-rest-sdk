...
class JournalEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CROSSREFREST_TEST_JOURNAL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function journal_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CROSSREFREST_TEST_JOURNAL_ENTID");
