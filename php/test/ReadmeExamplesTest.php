...
// CrossrefRest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CrossrefRestSDK::test)
...
{
    private const SDK_CLASS = 'CrossrefRestSDK';
    ...
    private const SDK_BASE = 'crossrefrest_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../crossrefrest_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
