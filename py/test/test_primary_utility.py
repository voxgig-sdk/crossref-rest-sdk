...
_runner = makeRunner(TEST_JSON_FILE, CrossrefRestSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CrossrefRestSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CrossrefRestSDK.test(None, setup.get('a') or {})
