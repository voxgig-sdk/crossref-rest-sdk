...
class CrossrefRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CrossrefRestTestRunner.getenv("CROSSREFREST_TEST_LIVE")
        override = CrossrefRestTestRunner.getenv("CROSSREFREST_TEST_OVERRIDE")
        ...
        explain = CrossrefRestTestRunner.getenv("CROSSREFREST_TEST_EXPLAIN")
