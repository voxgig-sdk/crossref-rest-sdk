# CrossrefRest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CrossrefRestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CrossrefRestSDK(...) and CrossrefRestSDK.test(...) become
#      CrossrefRestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "crossrefrest_sdk"
_SDK_CLASS = "CrossrefRestSDK"
