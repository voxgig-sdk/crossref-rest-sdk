...
from crossrefrest_sdk.core.helpers import get_ctx_prop, to_map
...
class CrossrefRestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, CrossrefRestSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CrossrefRestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CrossrefRestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CrossrefRestError(code, msg, self)
