...
from crossrefrest_sdk.utility import register

# Load features
from crossrefrest_sdk.feature.base_feature import CrossrefRestBaseFeature
from crossrefrest_sdk.features import _has_feature, _make_feature
...
class CrossrefRestSDK:
    ...
    def get_utility(self):
        return CrossrefRestUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CrossrefRestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Funder(self, data=None) -> "FunderEntity":
        ...
        from crossrefrest_sdk.entity.funder_entity import FunderEntity
    ...
    def Journal(self, data=None) -> "JournalEntity":
        ...
        from crossrefrest_sdk.entity.journal_entity import JournalEntity
