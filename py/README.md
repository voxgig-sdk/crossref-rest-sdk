# CrossrefRest Python SDK



The Python SDK for the CrossrefRest API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Funder()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/crossref-rest-sdk/releases)) or
...
```
py/
├── crossrefrest_sdk.py         -- Main SDK module
